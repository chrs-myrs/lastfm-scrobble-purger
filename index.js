    ...
    (function (page) {
        request(options, function (error, response, body) {
            ...
            resTracks.filter(
                ...
                t => {
                    return {
                        csrfmiddlewaretoken: config.csfrtoken,
                ...
                .forEach(function (unscrobbleTrack, index, all) {
                    console.log("Page" + page + ": Deleting scrobble " + (index + 1) + " of " + all.length + ": " + unscrobbleTrack.artist_name + " - " + unscrobbleTrack.track_name + " @ " + (new Date(unscrobbleTrack.timestamp * 1000)).toUTCString())
